...
const routersMongo = require('./src/routersMongo/index')
const viewsRouter = require('./src/routers/views.router')
const ProductManager = require('./src/dao/fileSystem/productsManager')
const configServer = require('./src/config/configServer')
const UsersManager = require('./src/dao/fileSystem/usersManager')
const chatManager = require('./src/dao/mongoDb/chat.mongo')
